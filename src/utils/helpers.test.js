        ...
        describe('5x3', () => {
            ...
            describe('duplicate', () => {
                ...
                it('get bottom right', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 3, 4, 0, { maskWidth: 5, maskHeight: 3, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom right 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 2, 3, 0, { maskWidth: 5, maskHeight: 3, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
            });
        });
        ...
        describe('5x5', () => {
            ...
            describe('ommit', () => {
                ...
                it('get top right', () => {
                    const expectedOutput =
                        'TODO make test';
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours = neighbours(inputPicture, 0, 4, 0, { maskWidth: 5, maskHeight: 5 });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom left', () => {
                    const expectedOutput =
                        'TODO make test';
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours = neighbours(inputPicture, 3, 0, 0, { maskWidth: 5, maskHeight: 5 });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
            });
            ...
            describe('duplicate', () => {
                ...
                it('get top left 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 1, 1, 0, { maskWidth: 5, maskHeight: 5, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get top right', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 0, 4, 0, { maskWidth: 5, maskHeight: 5, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get top right 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 1, 3, 0, { maskWidth: 5, maskHeight: 5, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom left', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 3, 0, 0, { maskWidth: 5, maskHeight: 5, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom left 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 2, 1, 0, { maskWidth: 5, maskHeight: 5, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom right', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 3, 4, 0, { maskWidth: 5, maskHeight: 5, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom right 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 2, 3, 0, { maskWidth: 5, maskHeight: 5, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
            });
        });
        ...
        describe('7x7', () => {
            ...
            describe('ommit', () => {
                ...
                it('get top left', () => {
                    const expectedOutput =
                        'TODO make test';
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours = neighbours(inputPicture, 0, 0, 0, { maskWidth: 7, maskHeight: 7 });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
            ...
            describe('duplicate', () => {
                ...
                it('get top left 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 1, 1, 0, { maskWidth: 7, maskHeight: 7, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get top right', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 0, 4, 0, { maskWidth: 7, maskHeight: 7, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get top right 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 1, 3, 0, { maskWidth: 7, maskHeight: 7, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom left', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 3, 0, 0, { maskWidth: 7, maskHeight: 7, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom left 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 2, 1, 0, { maskWidth: 7, maskHeight: 7, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
                ...
                it('get bottom right 1x1 offset', () => {
                    ...
                    const inputPicture = makeTestPicture(input);
                    const outputNeighbours =
                        neighbours(inputPicture, 2, 3, 0, { maskWidth: 7, maskHeight: 7, type: 'duplicate' });
                    expect(outputNeighbours).toEqual(expectedOutput);
                });
            });
        });
